    ...
    <div class="main-container">
        <div class="bill-container" v-for="bills in bill" :key="bills._id">
            <div class="bill-details">
                <p class="bill-no">Bill No: {{ bills.receiptNumber }}</p>
                <hr>

                <div class="wrap-billing">
                    <div class="billing">
                        <span>Dealer Name</span>
                        <p class="render">{{ bills.DelarName }}</p>
                    </div>
                ...
                <div class="wrap-billing-two">
                    <div class="billing">
                        <span>Dhami</span>
                        <p class="render">{{ bills.Dhami }}</p>
                    </div>

                    <div class="billing-pal">
                        <span>Pal</span>
                        <p class="render">{{ bills.pal }}</p>
                    </div>
                </div>
    ...
    <div class="popup">
      ...
      <form @submit.prevent="saveChanges">
        <div class="popup-content">
          ...
          <input type="tel" v-model="editableBill.due" readonly />
...
async function fetchBillData() {
    try {
        const response = await axios.get("https://j-k-managment-backend.onrender.com/purchase/AllMandiPurchase"); // Replace with your API endpoint
...
async function saveChanges() {
    try {
        ...
        await axios.post(`https://j-k-managment-backend.onrender.com/purchase/updateMandiPurchasedata`, editableBill.value);
...
function updateDueAmount() {
    editableBill.value.due = editableBill.value.totalPayment - editableBill.value.paid;
}
